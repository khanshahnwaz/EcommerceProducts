...
const ProductCard = ({ image, price, description ,rating,count}) => {
  return (
    <div className=" bg-white shadow-lg rounded-xl  h-max transition-opacity duration-500 ease-in-out hover:opacity-50 hover:shadow-3xl cursor-pointer p-5 text-center ">
      <img className="w-auto h-60 mx-auto" src={image} alt="Product" />
